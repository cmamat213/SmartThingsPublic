/**
 *	SmartThings device handler implementation for Aeon Labs Aeotec Micro Smart Switch Gen2 z-wave device.
 *	Written by Chase Mamatey (cmamat213+dev@gmail.com), cloned from Smart Dimmer device handler.
...
metadata {
	...
	definition (name: "aeon-labs-micro-smart-switch-gen2", namespace: "cmamat213", author: "Chase Mamatey") {
